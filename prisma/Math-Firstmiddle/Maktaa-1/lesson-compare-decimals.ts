  ...
  const lessonContent = `
    ...
    <div style="background-color: #f0f9ff; padding: 15px; border-radius: 10px; margin: 15px 0;">
      ...
      <table border="1" cellpadding="10" style="border-collapse: collapse; width: 80%; margin: auto; text-align: center;">
        ...
        <tr><td>&gt;</td><td>أكبر من</td><td>5 &gt; 3</td></tr>
        <tr><td>&lt;</td><td>أصغر من</td><td>2 &lt; 4</td></tr>
    ...
    <div style="display: flex; justify-content: center; margin: 20px 0;">
      <div style="background-color: #e8f5e8; padding: 20px; border-radius: 10px; text-align: center; width: 80%;">
        ...
        <div style="display: flex; justify-content: space-around; margin-top: 10px; gap: 10px;">
          <div style="background-color: #4CAF50; color: white; padding: 10px; border-radius: 5px; width: 45%;"><strong>الجزء الصحيح</strong></div>
          <div style="background-color: #2196F3; color: white; padding: 10px; border-radius: 5px; width: 45%;"><strong>الجزء العشري</strong></div>
        </div>
      </div>
    </div>
    ...
    <div style="background-color: #f6f6f6; padding: 15px; border-radius: 10px; margin-bottom: 15px;">
      ...
      <p>الخطوة 1: نقارن الجزء الصحيح → 15 أكبر من 12.</p>
    ...
    <div style="background-color: #f6f6f6; padding: 15px; border-radius: 10px; margin-bottom: 15px;">
      ...
      <p>النتيجة: <strong style="color: red; font-size: 1.2em;">7,25 &lt; 7,3</strong></p>
    </div>
    ...
    <div style="background-color: #f6f6f6; padding: 15px; border-radius: 10px; margin-bottom: 15px;">
      ...
      <p>الخطوة 2: نوحد الخانات: 4,13 → 4,130.</p>
      <p>الخطوة 3: نقارن الأعشار (1 = 1)، ثم أجزاء المئة (2 &lt; 3).</p>
      <p>النتيجة: <strong style="color: red; font-size: 1.2em;">4,127 &lt; 4,13</strong></p>
    </div>
    ...
    <div style="background-color: #fff3e0; padding: 15px; border-radius: 10px; margin: 15px 0;">
      ...
      <ol>
        <li>نوحد عدد الخانات: 3,20 - 2,80 - 3,15 - 2,75.</li>
        <li>نقارن الأجزاء الصحيحة: (2,80 و 2,75) أصغر من (3,20 و 3,15).</li>
        <li>نرتب مجموعة الـ 2: 2,75 &lt; 2,80.</li>
        <li>نرتب مجموعة الـ 3: 3,15 &lt; 3,20.</li>
      </ol>
      <p><strong>الترتيب النهائي:</strong> 2,75 &lt; 2,8 &lt; 3,15 &lt; 3,2</p>
    </div>
